...
현재 운영 이미지의 재생성에 필요한 도구만 이 폴더에 둡니다.
...
- `build-countdown-stickers-v120.mjs`: 카운트다운 스티커 생성
- `optimize-runtime-assets.mjs`: 운영 이미지 용량 최적화

과거 버전 전용 도구는 `old/scripts/`에 보관합니다.
